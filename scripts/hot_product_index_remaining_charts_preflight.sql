...
FROM (
  ...
  UNION ALL SELECT 'ads_pdm_lx_hot_product_index_sku_d', 'spu_previous_month_sales_amount_usd'
  ...
  UNION ALL SELECT 'ads_pdm_lx_hot_product_index_sku_m', 'spu_previous_month_sales_amount_usd'
